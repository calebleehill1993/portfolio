document.getElementById("weatherSubmit").addEventListener("click", function(event) {
  ...
  const url = "http://api.openweathermap.org/data/2.5/weather?q=" + value + ",US&units=imperial" + "&APPID=" + appid;
  fetch(url)
  ...
  const url2 = "http://api.openweathermap.org/data/2.5/forecast?q=" + value + ", US&units=imperial" + "&APPID=" + appid;
  fetch(url2)
    .then(function(response) {
      return response.json();
    }).then(function(json) {
